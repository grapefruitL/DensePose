...
import detectron.utils.vis_kk as vis_utils
...
def main(args):
    ...
    save_path = args.input.replace('.mp4','_output.mp4')
    ...
    while (cap.isOpened() and grab <= total_frames):
        ...
        # cv2.imwrite('./tools_kk/1.jpg',img)
        # break
        frame_no = frame_no +1
    cap.release()
...
'''
python2 tools_kk/infer_vid.py \
    --cfg configs/DensePose_ResNet101_FPN_s1x-e2e.yaml \
    --output-dir DensePoseData/infer_out/    \
    --wts ./DensePoseData/DensePose_ResNet101_FPN_s1x-e2e.pkl \
    --input-file tools_kk/video.mp4
'''
'''
python2 tools_kk/infer_simple.py \
    --cfg configs/DensePose_ResNet101_FPN_s1x-e2e.yaml \
    --output-dir DensePoseData/infer_out/ \
    --image-ext jpg \
    --wts ./DensePoseData/DensePose_ResNet101_FPN_s1x-e2e.pkl \
    DensePoseData/demo_data/grc.jpg
'''